...
<c:choose>
	...
	<div class="jumbotron">
	      <div class="container">
	        <h1>Hello, ${sid}</h1>
	        <p>This is place where your Id is Deleted</p>
	        <div class="container">
				<h2>User Delete</h2>
				<form action="/web/deletepro.0211" method="post" onsubmit="return check()">
				  <div class="form-group">
				    <label for="pw">*User Pw</label>
				    <input type="password" name="pw" class="form-control" id="pw" placeholder="Plz pw">
				  </div>
				  <div class="form-group">
				    <label for="pwch">*User Pw</label>
				    <input type="password" name="pwch" class="form-control" id="pwch" placeholder="Plz Pwch">
				  </div>
